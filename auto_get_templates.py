...
def main():
    print("=========================================")
    print("    AUTO SETUP SCRIPT (LẤY ẢNH MẪU)")
    print("=========================================")
    print("Vui lòng đảm bảo:")
    print("1. Đã chạy file measure_board.py trước đó để đo bàn cờ.")
    print("2. Trình duyệt đang mở Chess.com (hoặc trang cờ của bạn).")
    print("3. Bàn cờ đang ở vị trí XUẤT PHÁT (chưa có nước đi nào).")
