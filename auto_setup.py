...
def measure_and_save_bbox():
    print("=========================================")
    print("    AUTO SETUP SCRIPT (ĐO BÀN CỜ & LẤY MẪU)")
    print("=========================================")
...
def extract_templates():
    print("\n=== BƯỚC 3: TRÍCH XUẤT ẢNH MẪU TỰ ĐỘNG ===")
    ...
    # Lưu lại player_color vào config
    if os.path.exists("config.json"):
        with open("config.json", "r", encoding="utf-8") as f:
            config = json.load(f)
